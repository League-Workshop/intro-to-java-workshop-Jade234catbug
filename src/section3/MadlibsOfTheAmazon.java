...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjetive = JOptionPane.showInputDialog(null, "Enter an adjative");
		...
		String madLib = ("Pirahnahs are more" + adjetive + "during the day, so corss the river at night"
				+ "Pirahnahs are attracted to fresh" + liquid + "and will most likely take a bite out of your" + bodyPart + "if you" + verb +
